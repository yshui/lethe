...
struct MustacheEngine(String = string) if (isSomeString!(String))
{
      ...
      private:
        ...
        struct Section
        {
            ...
            @safe nothrow
            {
                ...
                this(String delegate(String) @trusted f)
                {
  ...
  public:
    ...
    */
     ...
     */
    @safe String renderString()(in String src, in Context context)
    {
        auto sink = appender!String();
     ...
     */
    @safe void renderString(Sink)(in String src, in Context context, ref Sink sink)
        if(isOutputRange!(Sink, String))
    {
  ...
  private:
     ...
     */
    @trusted void renderImpl(Sink)(in Node[] nodes, in Context context, ref Sink sink)
        if(isOutputRange!(Sink, String))
    {
     ...
     */
    @trusted static Node[] compile(String src)
    {
